...
if (isset($_POST['signup'])) {
    ...
    if (!$error) {
        if(mysqli_query($con, "INSERT INTO admin(name,email,password,cpassword) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "', '" . md5($cpassword) . "')")) {
            $successmsg = "Successfully Registered! <a href='adminn.php'>Click here to Login</a> ";
    ...
    <div class="cont_centrar cent_active">
        <div class="cont_login">
            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                    ...
                    <div class="cont_tabs_login">
                        <ul class="ul_tabs">
						    <li><a href="signup2.php" onclick="sign_up()">SignUp</a>
							<span class="linea_bajo_nom"></span></li>
								    
                          <li class="active">
						  <a href="adminn.php" onclick="sign_in()"></a>
						  <span class="linea_bajo_nom"></span></li>
