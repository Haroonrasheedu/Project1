...
<form action="creceipt.php" method="post">
...
<label for="field5"><span>Phone<span class="required">*</span></span><input type="text" class="input-field" name="phone" value="<?php echo $phone; ?>" /></label>
