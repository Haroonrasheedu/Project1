...
$odate = mysqli_real_escape_string($link, $_POST['odate']);
$rndate = mysqli_real_escape_string($link, $_POST['rndate']);
$arrid = mysqli_real_escape_string($link, $_POST['arrid']);
$flydate = mysqli_real_escape_string($link, $_POST['flydate']);
$fid = mysqli_real_escape_string($link, $_POST['fid']);
$arrdate = mysqli_real_escape_string($link, $_POST['arrdate']);
$colid = mysqli_real_escape_string($link, $_POST['colid']);
...
$drname = mysqli_real_escape_string($link, $_POST['drname']);
$ncnd = mysqli_real_escape_string($link, $_POST['ncnd']);
$jobout = mysqli_real_escape_string($link, $_POST['jobout']);
$sing = mysqli_real_escape_string($link, $_POST['sing']);
$remarks = mysqli_real_escape_string($link, $_POST['remarks']);
$awbno = mysqli_real_escape_string($link, $_POST['awbno']);
$phone = mysqli_real_escape_string($link, $_POST['phone']);
$routename = mysqli_real_escape_string($link, $_POST['routename']);
$routeno = mysqli_real_escape_string($link, $_POST['routeno']);
...
// attempt insert query execution
// attempt insert query execution
$sql = "INSERT INTO delivery (routename, routeno, phone, awbno, rndate, oid, flat, build, street, area, city, country, drname, ncnd, jobout, sing, remarks, arrid, odate, fid, arrdate, dcode, vanno, scase, flydate, coldate, reason, rackin, ddate, batchdate, batchin, batchout, passno, email, cc, coundate, rdate, dtype, ptype, stype, pcity, instatus, amt, descr, qty, cid, bdate, paytype, rid, outstatus, bid, batchoutdate, colid) VALUES ('$routename', '$routeno', '$phone', '$awbno', '$rndate', '$oid', '$flat', '$build', '$street', '$area', '$city', '$country', '$drname', '$ncnd', '$jobout', '$sing', '$remarks', '$arrid', '$odate', '$fid', '$arrdate', '$dcode', '$vanno', '$scase', '$flydate', '$coldate', '$reason', '$rackin', '$ddate', '$batchdate', '$batchin', '$batchout', '$passno', '$email', '$cc', '$coundate', '$rdate', '$dtype', '$ptype', '$stype', '$pcity', '$instatus', '$amt', '$descr', '$qty', '$cid', '$bdate', '$paytype', '$rid', '$outstatus', '$bid', '$batchoutdate', '$colid')";
