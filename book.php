...
<label for="field2"><span>Receipt Date<span class="required">*</span></span>
<input type="text" class="input-field" name="rdate" value="" /></label>
...
<input type="text" class="input-field" name="cid" value="" /></label>
...
<input type="text" class="input-field" name="cname" value="" /></label>
<label for="field2"><span>Passport No<span class="required">*</span></span>
<input type="text" class="input-field" name="passno" value="" /></label>
<label for="field4"><span>First Name<span class="required">*</span></span>
<input type="text" class="input-field" name="fname" value="" /></label>
<label for="field2"><span>Last Name<span class="required">*</span></span>
<input type="text" class="input-field" name="lname" value="" /></label>
<label for="field2"><span>Sur Name<span class="required">*</span></span>
<input type="text" class="input-field" name="sname" value="" /></label>
<label for="field2"><span>Issue Date<span class="required">*</span></span>
<input type="text" class="input-field" name="idate" value="" /></label>
<label for="field5"><span>Expiry Date<span class="required">*</span></span>
<input type="text" class="input-field" name="edate" value="" /></label>
<label for="field2"><span>Place Issue<span class="required">*</span></span>
<input type="text" class="input-field" name="pissue" value="" /></label>
<label for="field5"><span>Fathers Name<span class="required">*</span></span>
<input type="text" class="input-field" name="faname" value="" /></label>
<label for="field2"><span>Phone<span class="required">*</span></span>
<input type="text" class="input-field" name="phone" value="" /></label>
<label for="field5"><span>Flat<span class="required">*</span></span>
<input type="text" class="input-field" name="flat" value="" /></label>
<label for="field6"><span>Building<span class="required">*</span></span>
<input type="text" class="input-field" name="build" value="" /></label>
<label for="field7"><span>Street <span class="required">*</span></span>
<input type="text" class="input-field" name="street" value="" /></label>
<label for="field8"><span>Area <span class="required">*</span></span>
...
<option value="Pick-up-Cash">Home Delivery</option>
<option value="COD">Self Collection</option>
...
<label for="field2"><span>Entry Date<span class="required">*</span></span><input type="text" class="input-field" name="entdate" value="" /></label>
...
<label for="field2"><span>Amount<span class="required">*</span></span><input type="text" class="input-field" name="amt" value="" /></label>
<label for="field2"><span>Description<span class="required">*</span></span><input type="text" class="input-field" name="desc" value="" /></label>
...
<fieldset>
<legend>Booking Details</legend>
<label for="field9"><label for="field4"><span>Delivery Type</span><select name="mode" class="select-field">
<option value="Pick-up-Cash">Home Delivery</option>
<option value="COD">Self Collection</option>
<option value="Customer">Other</option>
</select></label>
<label for="field9"><label for="field4"><span>Product Type</span><select name="mode" class="select-field">
<option value="Pick-up-Cash">Passport</option>
<option value="COD">NIC</option>
<option value="Customer">Other</option>
</select></label>

<label for="field9"><label for="field4"><span>Processing City</span><select name="mode" class="select-field">
<option value="Pick-up-Cash">Dubai/sharjah</option>
<option value="COD">Abudhabi</option>
<option value="Customer">Other</option>
</select></label>
<label for="field2"><span>Counter Date /Time<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field2"><span>Status<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field2"><span>Pieces<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field2"><span>Amount<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field2"><span>Description<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>

<label for="field3"><span>Booking Date<span class="required">*</span></span><input type="text" class="input-field" name="date" value="" /></label>
<label for="field2"><span>Booking ID<span class="required">*</span></span><input type="text" class="input-field" name="consphone" value="" /></label>
<label for="field3"><span>Counter centre<span class="required">*</span></span><input type="text" class="input-field" name="accno" value="" /></label>
<label for="field2"><span>Receipt ID<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field2"><span>Receipt Date<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field9"><label for="field4"><span>Delivery Type</span><select name="mode" class="select-field">
<option value="Pick-up-Cash">Top Urgent</option>
<option value="COD">Urgent</option>
<option value="Customer">Normal</option>
</select></label>
<label for="field9"><label for="field4"><span>Sequence Type</span><select name="mode" class="select-field">
<option value="Pick-up-Cash">Sequence 1</option>
<option value="COD">Sequence 2</option>
<option value="Customer">Other</option>
</select></label>
<label for="field2"><span>Batch ID<span class="required">*</span></span><input type="text" class="input-field" name="sphone" value="" /></label>
<label for="field5"><span>BatchDate<span class="required">*</span></span><input type="text" class="input-field" name="sflat" value="" /></label>
...
<label for="field2"><span>Quantity<span class="required">*</span></span><input type="text" class="input-field" name="pieces" value="" /></label>
