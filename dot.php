...
$sql = "INSERT INTO count (coundate, cc, cid, passno, lname, fname, sname, faname, idate, edate, dob, flat, build, street, area, city, country, status, ptime, ptype, dtype, pcity, paytype, qty, amt, descr) VALUES ('$coundate', '$cc', '$cid', '$passno', '$lname', '$fname', '$sname', '$faname', '$idate', '$edate', '$dob', '$flat', '$build', '$street', '$area', '$city', '$country', '$status', '$ptime', '$ptype', '$dtype', '$pcity', '$paytype', '$qty', '$amt', '$descr')";
...
echo "Your Receipt is Created, Please Book your delivery";
} else{
