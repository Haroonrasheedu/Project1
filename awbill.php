...
<body>
<form action="awbill.php" method="post">
   ...
   <table style="color:purple;border-style:groove; height:150px;width:350px" background="backimage.jpg">
            ...
            <tr>
                <td style="color:red;background-color:aqua;height:25px">Enter Account no&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="cid" id="cid" type="text"/></td>
            </tr>
            <tr>
...
if(isset($_POST['search']))
{
	...
	$query = "SELECT * FROM count WHERE CONCAT(cid) LIKE '%".$valueToSearch."%'";
...
$result = mysql_query("select * from signup where cid='$_POST[cid]'");
...
$edate= $rowval['edate'];
$dob= $rowval['dob'];
$pissue= $rowval['pissue'];
$faname= $rowval['faname'];
$flat= $rowval['flat'];
$build= $rowval['build'];
$street= $rowval['street'];
$area= $rowval['area'];
$city= $rowval['city'];
}
mysql_close($con);
...
<option value='<?php echo  $city; ?>'>Dubai</option>
<option value='<?php echo  $city; ?>'>Abudhabi</option>
<option value='<?php echo  $city; ?>'>Sharjah</option>
</select></label>
...
<label for="field3"><span>Counter ID<span class="required">*</span></span><input type="text" class="input-field" name="cc" value="" /></label>
<label for="field3"><span>Counter Register Date<span class="required">*</span></span><input type="text" class="input-field" name="coundate" value="" /></label>
