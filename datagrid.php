...
// sending query
$result = mysql_query("select scase, email, rid, cc, cid, passno, ptype, dtype, instatus, batchdate, outstatus, batchoutdate, reason FROM {$table} where batchoutdate = '$_POST[batchoutdate]' OR batchdate = '$_POST[batchdate]' OR rid = '$_POST[rid]' OR cc = '$_POST[cc]' OR cid = '$_POST[cid]' OR rid = '$_POST[rid]' OR scase = '$_POST[scase]' OR email = '$_POST[email]' Or fid = '$_POST[fid]'");
if (!$result) {
