...
$result = mysql_query("select * from count where rid='$_POST[rid]'");
...
<form action="booking.php" method="post">
 ...
 <fieldset><legend> Please Enter the Customer ID </legend>
...
<label for="field2"><span>Batch ID<span class="required">*</span></span><input type="text" class="input-field" name="batchid" value="" /></label>
<label for="field5"><span>BatchDate<span class="required">*</span></span><input type="text" class="input-field" name="batchdate" value="" /></label>
...
<label for="field9"><label for="field4"><span>Sequence Type</span><select name="sortype" class="select-field">
...
<label for="field3"><span>Counter Centre<span class="required">*</span></span><input type="text" class="input-field" name="cc" value="<?php echo $cc; ?>" /></label>
<label for="field3"><span>nty<span class="required">*</span></span><input type="text" class="input-field" name="nty" value="<?php echo $nty; ?>" /></label>

</fieldset>
<fieldset><legend>Payment Details</legend>

<label for="field2"><span>Status<span class="required">*</span></span><input type="text" class="input-field" onkeypress="myFunction() name="status" value="<?php echo $status; ?>" />
</label>
