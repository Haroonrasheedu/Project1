...
<form action="dotmatrix2.php" name="myform" method="post">
<div class="form-style-3">
...
<label for="field2"><span>Collection date<span class="required">*</span></span><input type="text" class="input-field" name="coldate" value="" /></label>
...
<label for="field2"><span>OutStatus<span class="required">*</span></span><input type="text" class="input-field" name="outstatus" value="<?php echo $outstatus; ?>" /></label>
</fieldset>
</br>
</br>
</br>
