...
$result = mysql_query("select * from batch where email='$_POST[email]'");
while($rowval = mysql_fetch_array($result))
 {
	 ...
	 $email= $rowval['email'];
	 $rackid= $rowval['rackid'];
	 $ddate= $rowval['ddate'];
$bid= $rowval['bid'];
$rid= $rowval['rid'];
$rdate= $rowval['rdate'];
$batchid= $rowval['batchid'];
...
<form action="batchout.php" method="post">
...
<form action="batchoutdb.php" name="myform" method="post">
<div class="form-style-3">
...
<label for="field2"><span>Batch Date<span class="required">*</span></span><input type="text" class="input-field" name="batchdate" value="<?php echo $batchdate; ?>" /></label>
<label for="field3"><span>Delivery Date<span class="required">*</span></span><input type="text" class="input-field" name="ddate" value="<?php echo $ddate; ?>" /></label>

</div>

<div class="form-style-4">
<fieldset><legend>Batch-out Details</legend>
<label for="field2"><span>Batchout Date<span class="required">*</span></span><input type="text" class="input-field" name="batchoutdate" value="" /></label>
<label for="field2"><span>Reason<span class="required">*</span></span><input type="text" class="input-field" name="reason" value="" /></label>

<label for="field3"><span>Rackid<span class="required">*</span></span><input type="text" class="input-field" name="rackid" value="<?php echo $rackid; ?>" /></label>
<label for="field2"><span>Batch ID<span class="required">*</span></span><input type="text" class="input-field" name="batchid" value="<?php echo $batchid; ?>" /></label>
<label for="field2"><span>Outstatus<span class="required">*</span></span><input type="text" class="input-field" name="outstatus" value="" /></label>
</fieldset>
</br>
</br>
</br>
