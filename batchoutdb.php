...
$sql = "INSERT INTO batchout (reason, email, rackid, cc, coundate, rdate, dtype, ptype, stype, instatus, outstatus, amt, descr, qty, cid, paytype, rid, bid, bdate, batchdate, batchoutdate, ddate, batchid, passno) VALUES ('$reason', '$email', '$rackid', '$cc', '$coundate', '$rdate', '$dtype', '$ptype', '$stype', '$instatus', '$outstatus', '$amt', '$descr', '$qty', '$cid', '$paytype', '$rid', '$bid', '$bdate', '$batchdate', '$batchoutdate', '$ddate', '$batchid', '$passno')";
