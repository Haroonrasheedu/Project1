...
<form action="dot1.php" name="myform" method="post">

<div class="form-style-3">
<fieldset><legend>Receipt Details</legend>
...
<label for="field2"><span>Receipt ID<span class="required">*</span></span><input type="text" class="input-field" name="rid" value="" /></label>
<label for="field2"><span>Receipt Date<span class="required">*</span></span><input type="text" class="input-field" name="rdate" value="" /></label>
<label for="field2"><span>Counter centre<span class="required">*</span></span><input type="text" class="input-field" name="cc" value="" /></label>
<label for="field2"><span>Counter Date<span class="required">*</span></span><input type="text" class="input-field" name="coundate" value="" /></label>
<label for="field2"><span>Customer ID<span class="required">*</span></span><input type="text" class="input-field" name="cid" value="" /></label>
...
<label for="field9"><label for="field4"><span>Delivery Type</span><select name="sortype" class="select-field">
...
<fieldset>
<legend>Booking Details</legend>
<label for="field9"><label for="field4"><span>Sorting Type</span><select name="dtype" class="select-field">
...
<label for="field9"><label for="field4"><span>SequenceType</span><select name="stype" class="select-field">
<option value="Pick-up-Cash">Sequence 1</option>
<option value="COD">Sequence 2</option>
<option value="Customer">Other</option>
</select></label>
<label for="field2"><span>BatchID<span class="required">*</span></span><input type="text" class="input-field" name="batchid" value="" /></label>
