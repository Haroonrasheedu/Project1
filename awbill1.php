...
if(isset($_POST['search']))
{
	...
	$result = mysql_query("select * from count where cid='$_POST[cid]'");
...
<input type="Submit" name="search" value="Enter the Receipt wish to print"><br><br>
...
<input id="header1" type="button" onclick="printDiv('printableArea')" value="Customer Receipt!" />
		<textarea id="header">LEOPARDS WORLDWIDE EXPRESS </textarea>
			<div id="identity">
			
		<div id="meta"><th>s</th></div>
            <textarea id="customer-title"><?php echo $fname . "\n" . $flat . " " . $build . " " . $street . " " . $area . " " . $flat . " " . $city . " " . $country; ?>
</textarea>
	...
	<div id="meta"><th>PRODCUT DETAILS</th></div>
            <textarea id="customer-title"><?php echo $status . "\n" . $ptype . "," . $dtype . "," . $ptime . ',' . $pcity . "," . $qty . "," . $amt; ?></textarea>

            <table id="meta">
                <tr>
                    <td class="meta-head">AWB No</td>
                    <td><textarea><?php echo $cid; ?></textarea></td>
                </tr>
                <tr>

                    <td class="meta-head">DATE</td>
                    <td><textarea><?php echo $coundate; ?></textarea></td>
                </tr>
                <tr>
		...
		<table id="items">
		  ...
		  <tr>
			  ...
			  <th>DESCRIPTION</th>
		 		  ...
		 		  <tr class="item-row">
		      <td class="item-name"><textarea><?php echo $ptype; ?></textarea></td>
		      <td class="description"><textarea><?php echo $dtype; ?></textarea></td>
		      <td class="description"><textarea><?php echo $qty; ?></textarea></td>
		      <td class="description"><textarea><?php echo $pieces; ?></textarea></td>
		      <td class="description"><textarea><?php echo $amt; ?></textarea></td>
