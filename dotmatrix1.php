...
$sql = "INSERT INTO booking (rackin, ddate, batchdate, batchin, passno, email, cc, coundate, rdate, dtype, ptype, stype, pcity, instatus, amt, descr, qty, cid, bdate, paytype, rid) VALUES ('$rackin', '$ddate', '$batchdate', '$batchin', '$passno', '$email', '$cc', '$coundate', '$rdate', '$dtype', '$ptype', '$stype', '$pcity', '$instatus', '$amt', '$descr', '$qty', '$cid', '$bdate', '$paytype', '$rid')";
