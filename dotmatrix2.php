...
// Escape user inputs for security
	...
	$dwiseid = mysqli_real_escape_string($link, $_POST['dwiseid']);
	$bid = mysqli_real_escape_string($link, $_POST['bid']);
	$seqtype = mysqli_real_escape_string($link, $_POST['seqtype']);
...
$sql = "INSERT INTO colletion (cc, coundate, rdate, dtype, ptype, stype, instatus, outstatus, amt, descr, qty, cid, bdate, batchid, paytype, rid, bid, seqtype, fid, coldate) VALUES ('$cc', '$coundate', '$rdate', '$dtype', '$ptype', '$stype', '$instatus', '$outstatus', '$amt', '$descr', '$qty', '$cid', '$bdate', '$batchid', '$paytype', '$rid', '$bid', '$seqtype', '$fid', '$coldate')";
