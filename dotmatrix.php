...
$idate = mysqli_real_escape_string($link, $_POST['idate']);
$edate = mysqli_real_escape_string($link, $_POST['edate']);
$pissue = mysqli_real_escape_string($link, $_POST['pissue']);
$faname = mysqli_real_escape_string($link, $_POST['faname']);
...
$dob = mysqli_real_escape_string($link, $_POST['dob']);
$paytpe = mysqli_real_escape_string($link, $_POST['paytype']);
$qty = mysqli_real_escape_string($link, $_POST['qty']);
$nty = mysqli_real_escape_string($link, $_POST['nty']);
...
$sql = "INSERT INTO count (passno, nty, fname, lname, sname, dob, idate, edate, pissue, faname, flat, build, street, area, city, country, dtype, ptype, stype, pcity, ptime, instatus, amt, descr, qty, cid, phone, email, coundate) VALUES ('$passno', '$nty', '$fname', '$lname', '$sname', '$dob', '$idate', '$edate', '$pissue', '$faname', '$flat', '$build', '$street', '$area', '$city', '$country', '$dtype', '$ptype', '$stype', '$pcity', '$ptime', '$instatus', '$amt', '$descr', '$qty', '$cid', '$phone', '$email', '$coundate')";


if(mysqli_query($link, $sql)){
echo "Successfully Registered!! Please print your receipt here!<a href='fetc.php'>Click here to Login</a>! ";
} else{
...
<input type="text" class="input-field" name="enter" value="enter" />
<body>
